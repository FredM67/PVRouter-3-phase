...
inline constexpr int16_t REQUIRED_EXPORT_IN_WATTS{ 40 };         /**< when set to a negative value, this acts as a PV generator */
inline constexpr int16_t DIVERSION_START_THRESHOLD_WATTS{ 100 }; /**< Adjust value as needed - this means 50W surplus is needed to start diversion */
