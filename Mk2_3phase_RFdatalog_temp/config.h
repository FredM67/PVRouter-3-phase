...
inline constexpr uint8_t relayPin{ 4 };         /**< for 3-phase PCB, relay trigger */
...
inline relayOutput<> relay_Output{ relayPin, 6000, 500, 1, 1 }; /**< config for relay diversion, see class definition for defaults */
