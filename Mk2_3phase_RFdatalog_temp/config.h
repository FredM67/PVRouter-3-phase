...
inline constexpr uint8_t relayPin{ 8 };      /**< for 3-phase PCB, relay trigger */
...
inline constexpr relayOutput<10> relay_Output{ relayPin, 1000, 200, 1, 1 }; /**< config for relay diversion, see class definition for defaults and advanced options */
