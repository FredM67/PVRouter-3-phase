...
//
inline constexpr float f_powerCal[NO_OF_PHASES]{ 0.058861F, 0.06174F, 0.058417F };
//
...
// close to unity.
inline constexpr float f_voltageCal[NO_OF_PHASES]{ 0.7475F, 0.7475F, 0.7475F }; /**< compared with Sentron PAC 4200 */
