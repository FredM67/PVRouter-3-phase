...
//
inline constexpr float f_powerCal[NO_OF_PHASES]{ 0.06749F, 0.06907F, 0.06805F };
//
...
// close to unity.
inline constexpr float f_voltageCal[NO_OF_PHASES]{ 1.03F, 1.03F, 1.03F }; /**< compared with Fluke 77 meter */
