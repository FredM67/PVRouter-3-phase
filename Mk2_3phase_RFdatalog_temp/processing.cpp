...
ISR(ADC_vect)
{
  ...
  switch (sample_index)
  {
    case 0:
      ...
      ADMUX = bit(REFS1) | bit(REFS0) | sensorV[1];  // the conversion for I1 is already under way
    ...
    case 1:
      ...
      ADMUX = bit(REFS1) | bit(REFS0) | sensorI[1];  // the conversion for V2 is already under way
      ++sample_index;                                // increment the control flag
      //
    ...
    case 2:
      ...
      ADMUX = bit(REFS1) | bit(REFS0) | sensorV[2];  // the conversion for I2 is already under way
      ++sample_index;                                // increment the control flag
      //
    ...
    case 3:
      ...
      ADMUX = bit(REFS1) | bit(REFS0) | sensorI[2];  // the conversion for V3 is already under way
      ++sample_index;                                // increment the control flag
      //
    ...
    case 4:
      ...
      ADMUX = bit(REFS1) | bit(REFS0) | sensorV[0];  // the conversion for I3 is already under way
      ++sample_index;                                // increment the control flag
      //
    ...
    case 5:
      ...
      ADMUX = bit(REFS1) | bit(REFS0) | sensorI[0];  // the conversion for V1 is already under way
