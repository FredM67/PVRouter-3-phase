...
//
constexpr float f_powerCal[NO_OF_PHASES]{0.04413f, 0.04472f, 0.04321f};
//
...
// close to unity.
constexpr float f_voltageCal[NO_OF_PHASES]{0.812f, 0.812f, 0.812f}; /**< compared with Fluke 77 meter */
//--------------------------------------------------------------------------------------------------
