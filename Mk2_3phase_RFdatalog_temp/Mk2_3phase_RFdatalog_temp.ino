...
//
constexpr float f_powerCal[NO_OF_PHASES]{0.06642f, 0.06675f, 0.06595f};
//
...
// close to unity.
constexpr float f_voltageCal[NO_OF_PHASES]{1.009f, 1.003f, 1.003f}; /**< compared with Fluke 77 meter */
//--------------------------------------------------------------------------------------------------
