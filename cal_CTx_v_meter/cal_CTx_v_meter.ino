...
//
constexpr float f_powerCal[NO_OF_PHASES]{0.05639f, 0.05642f, 0.05606f};
...
// close to unity.
constexpr float f_voltageCal[NO_OF_PHASES]{1.004f, 1.004f, 1.004f}; /**< compared with Fluke 77 meter */
