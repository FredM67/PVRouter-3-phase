...
//
constexpr float f_powerCal[NO_OF_PHASES]{0.06749f, 0.06907f, 0.06805f};
...
// close to unity.
constexpr float f_voltageCal[NO_OF_PHASES]{1.003f, 1.003f, 1.003f}; /**< compared with Fluke 77 meter */
