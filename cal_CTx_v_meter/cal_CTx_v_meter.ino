...
//
constexpr float f_powerCal[NO_OF_PHASES] {0.0558f, 0.0559f, 0.0561f};
...
// close to unity.
constexpr float f_voltageCal[NO_OF_PHASES] {1.01f, 1.02f, 1.01f}; /**< compared with Fluke 77 meter */
