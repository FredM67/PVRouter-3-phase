...
//
constexpr float f_powerCal[NO_OF_PHASES]{ 0.04224F, 0.04453F, 0.04275F };
...
// close to unity.
constexpr float f_voltageCal[NO_OF_PHASES]{ 0.7941F, 0.8010F, 0.7957F }; /**< compared with Fluke 77 meter */
