...
//
constexpr float f_powerCal[NO_OF_PHASES]{0.0543f, 0.0550f, 0.0545f};
...
// close to unity.
constexpr float f_voltageCal[NO_OF_PHASES]{1.01f, 1.01f, 1.01f} /*{1.03f, 1.03f, 1.03f}*/; /**< compared with Fluke 77 meter */
